...
const translations = {
  en: {
    ...
    'wallet.createNewInfo': 'Secure your digital assets with SCASH wallet',
    ...
    'wallet.invalidMnemonic': 'Invalid Recovery Phrase',
    'wallet.invalidMnemonicInfo': 'Please enter a valid 12-word recovery phrase.',
    ...
    'wallet.backupDownloaded': 'Backup Downloaded',
    'wallet.backupDownloadedInfo': 'Your wallet backup has been downloaded successfully. Please keep it safe!',
    'wallet.walletFileReady': 'Your wallet file is ready for download！',
    'wallet.walletCreatedSuccessfully': 'Wallet Created Successfully',
    'wallet.walletDownloadedSuccessfully': 'Your wallet file has been downloaded. Keep it safe!',
    ...
    'wallet.invalidWalletFile': 'Invalid Wallet File',
    'wallet.invalidWalletFileInfo': 'Please upload a valid wallet file.',
    ...
    'send.cancel': 'Cancel',
    'send.errorSign': 'Sign Transaction Failed',
    ...
    'send.messageFee': 'Msg Fee',
    'send.messageNetworkFee': 'Msg Net Fee',
    ...
    'send.engraveLoss': 'Engraving Cost',
    'send.engraveChunkCount': 'Characters',
    'send.engravePlaceholder': 'Enter text to engrave...',
    'send.engraveDesc': 'Permanently engrave your text on the blockchain, making it immutable and permanent.',
    'send.engraveInsufficient': 'Insufficient balance to complete engraving',
    'send.engraveButton': 'Confirm Engraving',
    'send.engraveSuccessMsg': 'Your text has been permanently engraved on the blockchain',
  ...
  zh: {
    ...
    'wallet.createNewInfo': '用 SCASH 钱包保护您的数字资产',
    ...
    'wallet.invalidMnemonic': '无效的恢复短语',
    'wallet.invalidMnemonicInfo': '请输入一个有效的12个单词恢复短语。',
    ...
    'wallet.backupDownloaded': '备份已下载',
    'wallet.backupDownloadedInfo': '您的钱包备份已下载。请妥善保管！',
    'wallet.walletFileReady': '您的加密钱包文件已准备就绪。下载并妥善保管！',
    'wallet.walletCreatedSuccessfully': '钱包创建成功',
    'wallet.walletDownloadedSuccessfully': '您的钱包文件已下载。请妥善保管！',
    ...
    'wallet.invalidWalletFile': '无效的钱包文件',
    'wallet.invalidWalletFileInfo': '请上传一个有效的钱包文件。',
    ...
    'send.engraveNetworkFee': '网络手续费',
    'send.engraveLoss': '刻字损耗',
    'send.engraveChunkCount': '字符',
    'send.engravePlaceholder': '输入您想永久保存的文字...',
    'send.engraveDesc': '将您的文字永久刻在区块链上，让它永远无法被篡改或删除。',
    'send.engraveInsufficient': '余额不足，无法完成刻字',
    'send.engraveButton': '确认刻字',
    'send.engraveSuccessMsg': '您的文字已永久刻在区块链上',
    'send.engraveFrom': '从:',
  ...
  ru: {
    ...
    'wallet.createNewInfo': 'Защитите свои цифровые активы с кошельком SCASH',
    ...
    'wallet.invalidMnemonic': 'Неверная фраза восстановления',
    'wallet.invalidMnemonicInfo': 'Пожалуйста, введите действительную фразу восстановления из 12 слов.',
    ...
    'wallet.backupDownloaded': 'Резервная копия скачана',
    'wallet.backupDownloadedInfo': 'Ваша резервная копия кошелька скачана. Пожалуйста, сохраните ее в безопасности!',
    'wallet.walletFileReady': 'Ваш зашифрованный файл кошелька готов. Скачайте и храните его в безопасности!',
    'wallet.walletCreatedSuccessfully': 'Кошелёк успешно создан',
    'wallet.walletDownloadedSuccessfully': 'Файл вашего кошелька загружен. Пожалуйста, сохраните его в безопасности!',
    ...
    'wallet.invalidWalletFile': 'Неверный файл кошелька',
    'wallet.invalidWalletFileInfo': 'Пожалуйста, загрузите действительный файл кошелька.',
    ...
    'action.engrave': 'Метка',
    'common.walletFunction': 'Функции кошелька',
    'balance.title': 'Баланс',
    'transactions.recent': 'Последние',
    'transactions.openExplorer': 'Открыть в обозревателе',
    'transactions.seeAll': 'Показать все',
    'transactions.received': 'Получено',
    'transactions.sent': 'Отправлено',
    'transactions.memPool': 'Пул',
    'transactions.particulars': 'Детали',
    ...
    'send.cancel': 'Отмена',
    'send.errorSign': 'Подпись транзакции не удалась',
    ...
    'send.messageNetworkFee': 'Комиссия сети',
    ...
    'send.engraveLoss': 'Стоимость гравировки',
    'send.engraveChunkCount': 'Символы',
    'send.engravePlaceholder': 'Введите текст для гравировки...',
    'send.engraveDesc': 'Навсегда нанесите текст на блокчейн, сделав его неизменным и постоянным.',
    'send.engraveInsufficient': 'Недостаточный баланс для завершения гравировки',
    'send.engraveButton': 'Подтвердить гравировку',
    'send.engraveSuccessMsg': 'Ваш текст навсегда нанесен на блокчейн',
    'send.engraveFrom': 'От:',
